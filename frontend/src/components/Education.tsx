...
const Education = () => {
  const education = {
    ...
    university: "Rajeev Institute of Technology",
    cgpa: "8.12",
  ...
  const certifications = [
    ...
    },
    {
      ...
      provider: "OneRoadmap",
      date: "2025",
      skills: ["Planning", "Development", "React"],
    },
    {
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Strong academic foundation complemented by industry-recognized
            certifications
          </p>
        </div>
            ...
            <div className="p-6 bg-gradient-to-r from-electric-blue to-electric-cyan bg-opacity-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold text-space-dark">
                    {education.cgpa}
                  </span>
                </div>
                <div className="flex items-center gap-2">
