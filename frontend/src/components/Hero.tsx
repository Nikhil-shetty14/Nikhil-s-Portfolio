        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="fade-in">
            <h1 className="text-5xl md:text-7xl font-bold mb-4">
              <span className="gradient-text">Hey I'm Nikhil V S</span>
            </h1>
          ...
          <div className="fade-in fade-in-delay-1">
            ...
            Full-Stack MERN & Mobile Developer with hands-on internship experience building production-ready applications.
            Experienced in integrating automation and AI-driven features to enhance user experience and efficiency.
            Passionate about solving real-world problems through clean architecture and innovative solutions. </p>
          </div>
